...
uses U_clientes, U_funcoes, U_produtos, U_dm, U_pdv, U_lancamentos,
  ...
  U_usuarios, U_caixa, U_dados_empresa;
...
procedure TF_inicial.Empresa1Click(Sender: TObject);
begin
   if F_dadosEmpresa= nil then
   F_dadosEmpresa:= TF_dadosEmpresa.Create(self);
   F_dadosEmpresa.ShowModal;
end;
