...
begin
  ShowMessage('Não pode remover este usuario ele e o   '+ TB_usuariouser_nome.Text);
  Exit;
end;
...
TB_usuario.Delete;
  ...
  ShowMessage('Não pode apagar usuarios que tenham vendas realizadas');
end;
...
begin
  if txt_listarTelas.Text = '' then
   ...
   // verificar se a tela ja é liberada para o usuario;
   ...
   open;
     ...
     begin
     ShowMessage('Esta tela já foi liberada para este usuario');
     exit;
     end;
