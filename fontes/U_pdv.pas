...
type
  TF_pdv = class(TForm)
    ...
    Label15: TLabel;
    Shape4: TShape;
    rd_vista: TRadioButton;
    rd_prazo: TRadioButton;
...
if txt_recebido.Value < txt_total.Value then
 ...
 begin
if rd_prazo.Checked= true then
 begin
if txt_recebido.Value < txt_total_prazo.Value then
  begin
 ShowMessage('O valor recebido nao pode ser menor que o valor total prazo');
 txt_recebido.SetFocus;
 Exit;
 ...
 txt_troco.Value:= txt_recebido.Value-txt_total_prazo.Value;
 //
end;
end;
